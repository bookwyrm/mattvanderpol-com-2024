(() => {
  ...
  var require_set_scrollbar_width = __commonJS({
    "node_modules/set-scrollbar-width/src/set-scrollbar-width.js"(exports, module) {
      var getScrollbarWidth = (cssVariableName = "--twcb-scrollbar-width") => {
  ...
  var import_set_scrollbar_width = __toESM(require_set_scrollbar_width());
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  ready_default(() => module_default.start());
  document.addEventListener("alpine:init", () => {
  });
  ready_default(() => (0, import_set_scrollbar_width.default)());
  ready_default(() => {
